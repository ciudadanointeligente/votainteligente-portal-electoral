...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Election.can_election'
        db.add_column(u'elections_election', 'can_election',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['candideitorg.Election'], null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Election.can_election'
        db.delete_column(u'elections_election', 'can_election_id')
