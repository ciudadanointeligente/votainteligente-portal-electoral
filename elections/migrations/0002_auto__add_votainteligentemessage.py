...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'VotaInteligenteMessage'
        db.create_table(u'elections_votainteligentemessage', (
            (u'message_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['writeit.Message'], unique=True, primary_key=True)),
            ('moderated', self.gf('django.db.models.fields.BooleanField')(default=False)),
        ))
        db.send_create_signal(u'elections', ['VotaInteligenteMessage'])


    def backwards(self, orm):
        # Deleting model 'VotaInteligenteMessage'
        db.delete_table(u'elections_votainteligentemessage')
