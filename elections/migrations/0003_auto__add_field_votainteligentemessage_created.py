...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'VotaInteligenteMessage.created'
        db.add_column(u'elections_votainteligentemessage', 'created',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, default=datetime.datetime(2013, 10, 15, 0, 0), blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'VotaInteligenteMessage.created'
        db.delete_column(u'elections_votainteligentemessage', 'created')
