...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'CandidatePerson.reachable'
        db.add_column(u'elections_candidateperson', 'reachable',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'CandidatePerson.reachable'
        db.delete_column(u'elections_candidateperson', 'reachable')
