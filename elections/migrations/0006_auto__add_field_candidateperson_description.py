...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'CandidatePerson.description'
        db.add_column(u'elections_candidateperson', 'description',
                      self.gf('django.db.models.fields.TextField')(default=''),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'CandidatePerson.description'
        db.delete_column(u'elections_candidateperson', 'description')
