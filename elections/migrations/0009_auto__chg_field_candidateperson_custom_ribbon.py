...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'CandidatePerson.custom_ribbon'
        db.alter_column(u'elections_candidateperson', 'custom_ribbon', self.gf('django.db.models.fields.CharField')(max_length=18, null=True))

    def backwards(self, orm):

        # Changing field 'CandidatePerson.custom_ribbon'
        db.alter_column(u'elections_candidateperson', 'custom_ribbon', self.gf('django.db.models.fields.CharField')(max_length=15, null=True))
