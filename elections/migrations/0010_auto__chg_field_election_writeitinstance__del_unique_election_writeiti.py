...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        db.alter_column(u'elections_election', 'writeitinstance_id', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['writeit.WriteItInstance'], unique=True, null=True))
        # Adding unique constraint on 'Election', fields ['writeitinstance']
        db.create_unique(u'elections_election', ['writeitinstance_id'])


        # Changing field 'Election.popit_api_instance'
        db.alter_column(u'elections_election', 'popit_api_instance_id', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['popit.ApiInstance'], unique=True, null=True))
        # Adding unique constraint on 'Election', fields ['popit_api_instance']
        db.create_unique(u'elections_election', ['popit_api_instance_id'])
