...
"""
This code was taken from https://github.com/stefanw/froide/blob/master/froide/helper/email_utils.py
Write-it is not making use of all the parts of email_utils but it could certainly do so in the future
"""
try:
...
class FroideEmailParser(object):
    ...
    # From here on this are the parts that Write-it is not using
